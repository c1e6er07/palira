    ...
    <div className="flex min-h-screen flex-col items-center kids-gradient-bg pt-28 pb-20">
      <main className="container flex flex-col gap-8">
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
          <div className="rounded-xl border bg-white/90 p-6 shadow">Produtos</div>
          <div className="rounded-xl border bg-white/90 p-6 shadow">Pedidos</div>
          ...
          <div className="rounded-xl border bg-white/90 p-6 shadow">Usuários</div>
        </div>
      </main>
    </div>
  )
